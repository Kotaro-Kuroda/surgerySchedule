...
for d in list_date:
    ...
    while not feasibility_criteria:
        ...
        for r in list_room:
            ...
            approx = log_normal_cc(a, mean_vec, variance_vec, waiting_list, ot1) + pulp.lpSum(grad_dict[surgery] * (x[surgery, r, d, l] - a[surgery]) for surgery in waiting_list) + grad_dict['ot'] * (ot[r, d, l] - ot1)
            ...
            operating_room_planning += ot[r, d, l] <= max_surgery_time(waiting_list) - T + 30
        ...
        for r in list_room:
            operating_room_scheduling += ot2[r, d, l] <= max_surgery_time(waiting_list) - T + 30
