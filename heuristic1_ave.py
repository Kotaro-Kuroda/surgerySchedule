                    ...
                    for surgery1 in waiting_list:
                        for surgery2 in waiting_list:
                            if surgery1 != surgery2:
                                if (surgery1, surgery2) in infeasible_pair_room and (surgery1, surgery2) not in infeasible_pair_surgeon:
                                    operating_room_planning += pulp.lpSum(
                                        ...
                                        q_val[surgery2, surgeon, d, i] == 1) <= 1
                                elif (surgery1, surgery2) not in infeasible_pair_room and (surgery1, surgery2) in infeasible_pair_surgeon:
                                    operating_room_planning += pulp.lpSum(
                                        x[surgery1, r, d, l] for r in list_room if
                                        x_val[surgery1, r, d, i] == 1) \
                                                               + pulp.lpSum(
                                        x[surgery2, r, d, l] for r in list_room if
                                        x_val[surgery2, r, d, i] == 1) <= 1
                                elif (surgery1, surgery2) in infeasible_pair_room and (surgery1, surgery2) in infeasible_pair_surgeon:
                                    operating_room_planning += pulp.lpSum(
                                        x[surgery1, r, d, l] for r in list_room if
                                        x_val[surgery1, r, d, i] == 1) \
                                                               + pulp.lpSum(
